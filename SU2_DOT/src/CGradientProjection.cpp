#include "../include/CGradientProjection.hpp"


CGradientProjection::CGradientProjection(const char* confFile,
  ...
  config_file_name = new char[MAX_STRING_SIZE];
  strcpy(config_file_name, confFile);
  SU2_MPI::SetComm(MPICommunicator);
}

CGradientProjection::~CGradientProjection() {
  delete[] config_file_name;
}

void CGradientProjection::Run() {
...
void CGradientProjection::SetProjection_FD(CGeometry *geometry, CConfig *config, CSurfaceMovement *surface_movement, su2double** Gradient){
...
void CGradientProjection::SetProjection_AD(CGeometry *geometry, CConfig *config, CSurfaceMovement *surface_movement, su2double** Gradient){
...
void CGradientProjection::OutputGradient(su2double** Gradient, CConfig* config, ofstream& Gradient_file){
...
void CGradientProjection::SetSensitivity_Files(CGeometry ***geometry, CConfig **config, unsigned short val_nZone) {
